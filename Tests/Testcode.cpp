//SPALM PCB TEST CODE
//You can run this code on the regular Blip R1 computer to see if everything is hooked up correctly.
#include <Wire.h>
#include <SD.h>
#include <SPI.h>
...
void setup() {
  ...
  Serial.println("Hey! I'm the flight computer for Project S. P. A. L. M.! Let's get started.");
  Serial.println();Serial.println();
  ...
  if (!bmp.begin()) {
    ...
    Serial.print(bmp.readAltitude(1024));
  ...
  */
  ...
  Serial.println("Now time to check the Leg servos");
  delay(500);
  Serial.println("We'll set each servo to 90 degrees and wiggle ±30 degrees");
  delay(500);
  Serial.println("First, the legservo1");
  delay(500);
  LegServo1.attach(LegServo1pin);
  LegServo1.write(90); delay(500);
  LegServo1.write(120); delay(500);
  LegServo1.write(90); delay(500);
  LegServo1.write(60); delay(500);
  LegServo1.write(90); delay(500);

  Serial.println("Now, the LegServo2");
  delay(500);
  LegServo2.attach(LegServo2pin);
  LegServo2.write(90); delay(500);
  LegServo2.write(120); delay(500);
  LegServo2.write(90); delay(500);
  LegServo2.write(60); delay(500);
  LegServo2.write(90); delay(500);

  Serial.println("Now, the LegServo3");
  delay(500);
  LegServo3.attach(LegServo3pin);
  LegServo3.write(90); delay(500);
  LegServo3.write(120); delay(500);
  LegServo3.write(90); delay(500);
  LegServo3.write(60); delay(500);
  LegServo3.write(90); delay(500);
  Serial.println("Now, the LegServo4");
  delay(500);
  LegServo4.attach(LegServo4pin);
  LegServo4.write(90); delay(500);
  LegServo4.write(120); delay(500);
  LegServo4.write(90); delay(500);
  LegServo4.write(60); delay(500);
  LegServo4.write(90); delay(500);
